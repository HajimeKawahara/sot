...
A,X,logmetric=runnmf.L2_NMF(Ntry,lcall,W,A0,X0,lamA,lamX,epsilon,off)
np.savez("ax_unc"+str(int(np.log10(lamA))),A,X)
np.savez("metric_unc"+str(int(np.log10(lamA))),logmetric)
