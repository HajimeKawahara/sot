...
## load class map
dataclass = np.load("/home/kawahara/sot/src/sot/data/cmap4class.npz")
...
(
    ...
    water,
    clear_sky,
) = io_refdata.read_refdata("/home/kawahara/sot/src/sot/data/refdata")
# mean albedo between waves and wavee
print(
    io_refdata.get_meanalbedo(veg, 0.8, 0.9), io_refdata.get_meanalbedo(veg, 0.4, 0.5)
)
