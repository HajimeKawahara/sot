...
def plotseqmap(movmap,frames,tag="map",title=None,zero=True,vmin=None,vmax=None,cmap=plt.cm.pink,Earth=False,boundary_data="/home/kawahara/exomap/sot/data/earth_boundary.npz",color="#66CC99",png=True,pdf=True, show=False):
    A = np.copy(movmap)
    if Earth:
