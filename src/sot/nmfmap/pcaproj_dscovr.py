#
# PCA projection DISCOVR (in Kawahara 2020)
#
...
if __name__=='__main__':
    ...
    axfile="npz/D203/D203L2-VRDet_A-2.0X-4.5j40000.npz"
    #axfile=sys.argv[1]
    ...
    plt.ylabel("PC2")
    plt.legend()        
    plt.savefig("pcaproj_dscovr.pdf", bbox_inches="tight", pad_inches=0.0)
    plt.show()
