...
s=0
plt.plot(resall[s:,0],label="$||D-WAX||_F^2+\lambda_A ||A||_F^2$")
plt.plot(resall[s:,1],label="$||D-WAX||_F^2$")
plt.plot(resall[s:,2],label="$\lambda_A ||A||_F^2$")
#plt.plot(resall[s:,3],label="X")
plt.legend()
plt.yscale("log")
plt.xscale("log")
